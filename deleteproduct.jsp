...
<!-- Basic page needs
        ...
        <title>Delete product | Tinker </title>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">DELETE PRODUCT DETAILS</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 d-flex img" style="background-image: url(images/bacgrd.jpg);">
							<div class="text w-100">
								<h2 class="mb-4">Delete Product Details Form</h2>
								<p></p>
							</div>
			      </div>
									...
									<form action="delete" method="POST" class="signup-form">
										...
										<div class="row">
											...
											<div class="col-md-6">
							      			...
							      			<input type="text" name="pname" id="name" placeholder="Product Name" value="<%= productname%>" readonly class="form-control"/>
							      		</div>
											</div>
											...
											<div class="col-md-12">
							      			...
							      			<input type="text" name="des" id="description" placeholder="Description"value="<%= description%>" readonly class="form-control"/><br><br> 
                                        ...
                                        <input type="number" name="img" id="Image" placeholder="" value="<%= image%>" readonly class="form-control"/>
                                        ...
                                        <input type="number" name="pri" id="Price" placeholder="Price" value="<%= price%>" readonly class="form-control"/>
											...
											<div class="col-md-12">
												<div class="form-group">
						            	<button type="submit" class="default-button">DELETE PRODUCT DETAILS</button><!--send it to the controller class DeleteproductServlet.java -->
						            </div>
											</div>
										</div>
