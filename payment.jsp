...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="payment" method="post">
                ...
                <div class="wrap-input100  ">
                    <label for="account_name">Name On Card
                    </label>
                    <input type="text" placeholder="Name On Card" class="form-control input-step-2-1" id="account_name" name="name" required>
                    
                </div>

                <div class="wrap-input100  ">
                    <label for="account_number">Card Number:</label>
                    <input type="number" placeholder="4576-6970-3801-2620" class="form-control input-step-2-2" id="account_number" name="num" required>
                    
                </div>

                <div class="wrap-input100  ">
                    <label for="date">Valid thru</label>
                    <input type="text" id="date" placeholder="MM / YY" class="form-control input-step-2-2" id="account_number" name="date" required/>
                    
                </div>

                <div class="wrap-input100  ">
                    <label for="verification">CVV / CVC *</label>
                                      <input type="password" id="verification" class="form-control input-step-2-2" placeholder="cvv/cvc" name="cvv" required/>
                ...
                <div class="container-login100-form-btn">
                    ...
                    <button type="submit" class="default-button">Pay</button>
                </div>
