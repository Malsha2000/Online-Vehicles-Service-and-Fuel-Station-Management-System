...
<![endif]-->
	...
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			...
			<form action="productServlet" method="post" class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter Product ID">
				
					<input class="input100" type="text" name="pid" placeholder="Product ID">
				...
				<div class="container-login100-form-btn">
					...
					<input class="login100-form-btn default-button" type="submit" name="submit" value="SUBMIT"><!--send it to the controller class productServlet.java -->
