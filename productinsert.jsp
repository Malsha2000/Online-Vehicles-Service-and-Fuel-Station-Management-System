...
<head>
    ...
    <script>
        function validateNullableInputs() {
            var pname = document.forms["InsertForm"]["pname"];
            var des = document.forms["InsertForm"]["des"];
            var img = document.forms["InsertForm"]["img"];
            var pri = document.forms["InsertForm"]["pri"];
            ...
            if (img.value == "") {
                window.alert(
                  "Please enter valid image address");
                img.focus();
                return false;
            }
...
<link rel="stylesheet" href="css3/style.css">
    ...
    <link rel="stylesheet" href="../webapp/plugins/node_modules/toastr/build/toastr.css">


    <script src="js1/vendor/modernizr-2.8.3.min.js"></script>
   
    
    <script src="../webapp/plugins/node_modules/jquery-validation/dist/additional-methods.min.js"></script>
    <script src="../webapp/plugins/node_modules/toastr/build/toastr.min.js"></script>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section">Add Products Details</h2>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="wrap d-md-flex">
                    <div class="text-wrap p-4 p-lg-5 d-flex img" style="background-image: url(images/backg.jpg);">
                        <div class="text w-100">
                            <h2 class="mb-4">New Product Details Form</h2>
                            <h5>Tinker offers a wide assortment of car wash products like shampoos and tools to go with them.</h5>
                      ...
                      <div class="col-lg-9">
                          <div class="social-wrap">
                              ...
                              <span></span>
                                ...
                                <form  id="productForm" action="insert" method="POST" class="signup-form" name="InsertForm" onsubmit="return validateform()">
                                  ...
                                  <input 
                                    ...
                                    <button 
                                        ...
                                        onclick="validateNullableInputs()"
