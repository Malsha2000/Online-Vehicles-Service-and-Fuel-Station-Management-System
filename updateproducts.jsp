...
<!-- Basic page needs
        ...
        <title>Update products | Tinker </title>
                                ...
                                <div class="main-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="about-us.html">Admin Home</a></li>
                                            <!-- single menu -->
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">UPDATE PRODUCT DETAILS</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 d-flex img" style="background-image: url(images/bacg.jpg);">
							<div class="text w-100">
								<h2 class="mb-4">Update Product Details Form</h2>
								<p></p>
							</div>
			      </div>
			      	...
			      	<div class="row justify-content-center py-md-5">
                          ...
                          %>
									<form method="POST" action="update" class="signup-form">
                                        <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                          <label class="label" for="name">Product ID</label>
                                          <input type="text" name="id" id="title" placeholder="Product Id" value="<%= productID%>" readonly class="form-control"/>
                                      </div>
                                        </div>
                                    </div>
										<div class="row">
											...
											<div class="col-md-6">
							      			...
							      			<input type="text" name="pname" id="name" placeholder="Product Name" value="<%= productname%>" required class="form-control"/>
							      		</div>
											</div>
											...
											<div class="col-md-12">
							      			...
							      			<input type="text" name="des" id="description" placeholder="Description"  value="<%= description%>" required class="form-control"/>
                                        ...
                                        <input type="text" name="img" id="image" placeholder="Image" value="<%= image%>" required class="form-control"/>
                                        <img alt="" src="<%= image%>"><br><br><br>
						            </div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
						            	<label class="label" for="password">Price</label>
                                        <input type="text" name="pri" id="price" placeholder="Price" value="<%= price%>" required class="form-control"/>
											...
											<div class="col-md-12">
												<div class="form-group">
						            	<button type="submit" class="default-button">Update Details</button><!--send it to the controller class UpdateproductServlet.java -->
						            </div>
											</div>
										</div>
